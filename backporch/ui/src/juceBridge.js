...
const MOCK_PRESETS = [
  { name: 'Front Porch', blurb: "the house sound — a small room you don't notice until it's gone" },
  { name: 'Nashville Slap', blurb: 'one bright reflection behind a vocal or a telecaster' },
  { name: 'Tight Ambience', blurb: 'just enough room to stop a dry track sounding pasted on' },
  { name: 'Drum Room', blurb: 'hard ducking so the tail lives between hits, not on top of them' },
  { name: 'Vocal Plate', blurb: 'the smooth one, dark enough to sit under a lead vocal' },
  { name: 'Guitar Verb', blurb: 'brighter plate for cleans and arpeggios' },
  { name: 'Wide Ballad', blurb: 'big and dark, ducked hard enough to keep the words intelligible' },
  { name: 'Long Tail', blurb: 'the one you can hear — for endings, pads and empty bars' }
];
