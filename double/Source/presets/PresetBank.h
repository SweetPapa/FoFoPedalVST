...
// DOUBLE's factory bank. Defined in PresetBank.cpp so this header stays clear
// of PluginProcessor.h — the processor includes it, so it cannot include back.
...
inline constexpr int kDefaultPresetIndex = 0;
