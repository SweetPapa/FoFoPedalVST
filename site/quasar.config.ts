...
export default defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      // history mode = clean /pedals/vroom URLs for SEO. Static hosts need an
      // SPA fallback (the build copies index.html → 404.html, which covers
      // GitHub Pages; Netlify/Cloudflare Pages handle SPA fallback natively).
    ...
    framework: {
      ...
      // Quasar plugins
      plugins: ['Meta'] // per-page SEO meta + JSON-LD via useMeta
    },
